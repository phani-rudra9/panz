  ...
  stages {
   ...
   stage('Docker build and push') {
	 ...
	 echo $access_key
         ...
         docker login -u AWS -p $DOCKER_LOGIN_PASSWORD https://737856137436.dkr.ecr.ap-south-1.amazonaws.com
         docker build -t 737856137436.dkr.ecr.ap-south-1.amazonaws.com/demo:SAMPLE-PROJECT-${BUILD_NUMBER} .
         docker push 737856137436.dkr.ecr.ap-south-1.amazonaws.com/demo:SAMPLE-PROJECT-${BUILD_NUMBER}
